...
const data = [
  ...
  {
    title: 'I Am Almost Finished with this Project',
    data: 'Sep 2nd, 2020',
...
function articleMaker(articleObj){
  // creating div element and adding 'article' class to it
  const article = document.createElement('div')
  article.classList.add('article');
  
  // creating h2 element and adding it as child of article
  const articleH2 = document.createElement('h2');
  articleH2.textContent = articleObj.title;
  article.append(articleH2);

  // creating paragraph elements and adding as children of article
  const paraDate = document.createElement('p');
  paraDate.classList.add('date');
  paraDate.textContent = articleObj.date;
  ...
  article.append(paraDate, paragraph1, paragraph2, paragraph3);
  
  // creating span.expandButton and adding to article
  ...
  article.append(spanExpandButton);

  // click event for span.expandButton
  spanExpandButton.addEventListener('click', event => {
...
// adding articles for every object in data
data.forEach(item => {
